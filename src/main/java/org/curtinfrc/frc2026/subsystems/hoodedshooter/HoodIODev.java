...
public class HoodIODev implements HoodIO {
  ...
  public static final double KP = 80.55;
  public static final double KI = 0;
  public static final double KD = 3.37;
  public static final double KS_OUT = 0.42;
  public static final double KS_STOWED = 0.12;
  ...
  private final List<StatusSignal<Temperature>> motorTemperatures = List.of(motor.getDeviceTemp());
  ...
  public void updateInputs(HoodIOInputs inputs) {
    inputs.motorTemperatures = new double[1];
    inputs.motorsConnected = new boolean[1];
