...
ViewerConfig LoadConfigFromEnv() {
  ...
  cfg.incomingCoordCalibrationProfilePath =
      GetEnvString("INCOMING_COORD_CALIBRATION_PROFILE_PATH", cfg.incomingCoordCalibrationProfilePath);
  cfg.incomingCoordCalibrationProfileName =
      GetEnvString("INCOMING_COORD_CALIBRATION_PROFILE_NAME", cfg.incomingCoordCalibrationProfileName);
